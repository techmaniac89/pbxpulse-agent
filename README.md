...
The current Agent release is `0.4.7-beta` on the **Breeze** channel.
...
```text
dist/
  PBXSenseAgent-0.4.7-beta-linux-source-installer.tar.gz
```
...
For a release tag such as `agent-v0.4.7-beta`, attach the matching files from
