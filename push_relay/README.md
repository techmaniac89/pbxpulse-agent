...
Relay service `0.4.7` provides the encrypted Internet Relay data path. Updated apps
...
The 0.4.7 cost profile is local-first: Agents check for changed relay snapshots
